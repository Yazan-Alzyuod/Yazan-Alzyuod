...
- Finite element analysis and simulation-driven design improvements  
- Prototyping, testing, and performance validation in field conditions  

## Technical Skills
CAD Engineering (SolidWorks, Creo, AutoCAD)

CAE & Simulation (Ansys, Abaqus, Working Model)

Programming & Simulink (MATLAB, Arduino)
...
- Aspire Institute (HarvardX-supported modules in leadership & strategy)
